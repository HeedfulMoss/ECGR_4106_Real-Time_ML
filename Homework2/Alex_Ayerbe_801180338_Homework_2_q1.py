...
# Define AlexNet model no dropout
...
class AlexNetDropout(nn.Module):
    def __init__(self, num_classes=10):
        super(AlexNetDropout, self).__init__()
        self.features = nn.Sequential(
            nn.Conv2d(3, 64, kernel_size=11, stride=4, padding=2),
            nn.ReLU(inplace=True),
            nn.MaxPool2d(kernel_size=3, stride=2),
...
compare_models([AlexNet, AlexNetDropout], optim_configs, train_loader_10, validation_loader_10, classes_cifar10, num_epochs=10, dataset_name="cifar10")
#compare_models([AlexNetDropout], train_loader_10, validation_loader_10, classes_cifar10, num_epochs=15, dataset_name="cifar10")


# ---- Call the function for CIFAR-100 ----
compare_models([AlexNet, AlexNetDropout], optim_configs, train_loader_100, validation_loader_100, classes_cifar100, num_epochs=10, dataset_name="cifar100")
